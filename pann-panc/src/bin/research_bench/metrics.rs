...
pub struct PatchScanReport {
    ...
    pub image_auroc: f64,
    pub mask_patch_count: usize,
    pub mask_positive_patch_count: usize,
    pub mask_patch_accuracy: Option<f64>,
    pub mask_patch_f1: Option<f64>,
    pub mask_patch_auroc: Option<f64>,
    pub train_ms: u128,
    pub inference_ms: u128,
    pub memory_bytes: usize,
