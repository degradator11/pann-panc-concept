...
This Rust application lives in `pann-panc/`. Run Cargo commands from this
directory:
...
`rich-texture`. `--image-features rich-layout` adds compact symmetry,
centroid, spread, center/border, and quadrant-balance features on top of
`rich-texture`.
